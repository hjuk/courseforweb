package com.guli.security.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.guli.security.entity.SecurityUser;
import com.guli.security.entity.User;
import com.guli.security.security.TokenManager;
import com.guli.utils.R;


import com.guli.utils.ResponseUtil;
...
public class TokenLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain,
        ...
        String token = tokenManager.createToken(user.getUser().getUsername());
